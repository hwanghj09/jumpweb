...
export const STAGES = [
  ...
  },
  {
    ...
    platforms: [
      ...
      { x: 13 * TILE, y: 27 * TILE, w: 3 * TILE, h: TILE, moving: { axis: 'y', range: 5 * TILE, speed: 1.0 } },
      ...
      { x: 15 * TILE, y: 15 * TILE, w: 3 * TILE, h: TILE, moving: { axis: 'y', range: 4 * TILE, speed: 1.1 } },
      { x: 12 * TILE, y: 11 * TILE, w: 8 * TILE, h: TILE },
      { x: 15 * TILE, y: 7 * TILE, w: 3 * TILE, h: TILE, moving: { axis: 'y', range: 2 * TILE, speed: 1.0 } },
